...
global.wlcm  = process.env.WELCOME || process.env.CAN_WELCOME || "ftrue";  // Make it "false" for disable WELCOME 
...
global.userImages= process.env.USER_IMAGES || "text" // "image" // set Image/video urls here
...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "2349138914032,2349138914032";


//========================= [ AUTO SAVE & READ STATUS ] =========================\\
global.read_status = process.env.AUTO_READ_STATUS || "true"
global.save_status = process.env.AUTO_SAVE_STATUS || "true"
global.save_status_from =  process.env.SAVE_STATUS_FROM  || "2349138914032,2349138914032";
...
// ========================= [ Disables in V.1.2.8 ] ===============================\\  
  ...
  //userImages:process.env.USER_IMAGES|| "image",  // SET IMAGE AND VIDEO URL FOR BOT MENUS 
