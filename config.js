...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "autoread,923xxxxxxxx";


//========================= [ AUTO SAVE & READ STATUS ] =========================\\
global.read_status = process.env.AUTO_READ_STATUS || "true"
global.save_status = process.env.AUTO_SAVE_STATUS || "true"
global.save_status_from =  process.env.SAVE_STATUS_FROM  || "none,923xxxxxxxx";
...
// ========================= [ Disables in V.1.2.8 ] ===============================\\  
  ...
  //MsgsInLog: process.env.MSGS_IN_LOG|| "falsee", // "true"  to see messages , "log" to open logs , "false" to hide logs messages
