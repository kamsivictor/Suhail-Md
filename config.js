...
global.appUrl=process.env.APP_URL || "https://wa.me/2349138914032"                       // put your app url here,
global.email ="saimsamsun789@gmail.com"
global.location="Lahore,Pakistan."


global.mongodb= process.env.MONGODB_URI || ".mongodb URI"
global.allowJids= process.env.ALLOW_JID || "Allow" 
global.blockJids= process.env.BLOCK_JID || "Block"
global.DATABASE_URL = process.env.DATABASE_URL || "database URL"
...
global.userImages= process.env.USER_IMAGES || "image and video URL" // "image and video URL" // set Image/video urls here
...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "null,2349138914032";


//========================= [ AUTO SAVE & READ STATUS ] =========================\\
global.read_status = process.env.AUTO_READ_STATUS || "true"
global.save_status = process.env.AUTO_SAVE_STATUS || "true"
global.save_status_from =  process.env.SAVE_STATUS_FROM  || "null,2349138914032";
...
module.exports = {
  ...
  ownername:process.env.OWNER_NAME|| "josh",
...
// ========================= [ Disables in V.1.2.8 ] ===============================\\  
  ...
  //userImages:process.env.USER_IMAGES|| "image and video URL",  // SET IMAGE AND VIDEO URL FOR BOT MENUS 
